...
| `checkin-policy.md` | Local ID-check law, the registration card and waiver text, the upsell catalogue's guest-facing description, and which lock vendor you would wire up. Read by `tools/checkin.py` and `prompts/invite.md` - see `docs/how-it-works.md`. |
